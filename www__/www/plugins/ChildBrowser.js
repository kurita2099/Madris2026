...
ChildBrowser.prototype.showWebPage = function(success,fail,loc)
{
    cordovaRef.exec( success, fail,"ChildBrowserCommand","showWebPage", [loc]);
};

// close the browser, will NOT result in close callback
ChildBrowser.prototype.close = function(success,fail)
{
    cordovaRef.exec( success, fail,"ChildBrowserCommand","close",[]);
};
...
ChildBrowser.install = function()
{
    if(!window.plugins) {
        ...
        window.plugins.childBrowser = new ChildBrowser();
           // alert('BBB='+window.plugins.childBrowser);
    }
